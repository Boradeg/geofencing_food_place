...
import com.example.geofencing_food_place.databinding.FragmentShopLocationBinding
...
class ShopLocationFragment : Fragment() {
    ...
    lateinit var binding:FragmentShopLocationBinding
    override fun onCreateView(
        ...
        binding.showButton.setText("Show List")
