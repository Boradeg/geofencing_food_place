...
class Locationshop : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_locationshop)
        val btndeatils = findViewById<Button>(R.id.btndetails)
        btndeatils.setOnClickListener {
            val intent = Intent(applicationContext,Showshopoffer::class.java)
    ...
    private fun getlocation() {
        ...
        task.addOnSuccessListener { location ->
            if (location != null) {
                ...
                val geocoder = Geocoder(this@Locationshop, Locale.getDefault())
